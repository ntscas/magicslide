...
export const DEFAULT_SCRIPT = "Welcome to MagicSlide Studio. This is an auto-generated slide description.";
export const DEFAULT_SUBTITLE = "Welcome to MagicSlide Studio.";
